...
# Aktuelle WLAN Konfiguration auslesen

function Get-FBWLANConfiguration(){
    $resp = New-Request -urn 'urn:dslforum-org:service:WLANConfiguration:1' -action 'GetInfo'
    return $resp.Envelope.body.GetInfoResponse
}

Get-FBWLANConfiguration